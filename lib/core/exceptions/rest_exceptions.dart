...
String  handleExceptions(dynamic error) {
  ...
  switch (error.runtimeType) {
    case SocketException:
      errorMessage = 'Your Internet is not stable,Please try again';
      break;
    case DioException:
...
bool isMsisdnExpire({required String msg}){
  log(msg,name:"token expire");

  if(msg=="MSISDN not matched")
  {

    log("MSISDN not matched login user again",name: "token expire");

    return true;
  }
  else{
    log("MSISDN is matched",name: "token expire");
    return false;
  }
}
